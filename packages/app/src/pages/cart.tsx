...
export type CartPageProps = PropsWithChildren<{
  readonly userId?: string;
  readonly data?: DeepReadonly<Record<string, unknown>>;
}>;

export const CartPage: FC<CartPageProps> = (props: CartPageProps) => {
...
export type CartPageData = DeepReadonly<{
  readonly title: string;
  readonly description: string;
  readonly metadata: DeepReadonly<Record<string, unknown>>;
}>;

export function getCartPageData(): CartPageData {
  return {
    title: 'Cart',
