...
export type OrdersPageProps = PropsWithChildren<{
  readonly userId?: string;
  readonly data?: DeepReadonly<Record<string, unknown>>;
}>;

export const OrdersPage: FC<OrdersPageProps> = (props: OrdersPageProps) => {
...
export type OrdersPageData = DeepReadonly<{
  readonly title: string;
  readonly description: string;
  readonly metadata: DeepReadonly<Record<string, unknown>>;
}>;

export function getOrdersPageData(): OrdersPageData {
  return {
    title: 'Orders',
