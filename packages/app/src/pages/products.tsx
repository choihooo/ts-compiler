...
export type ProductsPageProps = PropsWithChildren<{
  readonly userId?: string;
  readonly data?: DeepReadonly<Record<string, unknown>>;
}>;

export const ProductsPage: FC<ProductsPageProps> = (props: ProductsPageProps) => {
...
export type ProductsPageData = DeepReadonly<{
