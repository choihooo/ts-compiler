...
export const CheckoutPage: FC<CheckoutPageProps> = (props: CheckoutPageProps) => {
...
export type CheckoutPageData = DeepReadonly<{
  readonly title: string;
  readonly description: string;
  readonly metadata: DeepReadonly<Record<string, unknown>>;
}>;

export function getCheckoutPageData(): CheckoutPageData {
  return {
    title: 'Checkout',
