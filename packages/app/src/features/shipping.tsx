...
export type ShippingFeatureProps = PropsWithChildren<{
...
export const ShippingFeature: FC<ShippingFeatureProps> = (props: ShippingFeatureProps) => {
...
export type ShippingFeatureData = DeepReadonly<{
  readonly id: string;
  readonly name: string;
  readonly config: DeepReadonly<Record<string, unknown>>;
}>;

export function getShippingFeatureData(): ShippingFeatureData {
  return {
    id: 'shipping-1',
    name: 'Shipping',
    config: {},
...
export function transformShippingFeatureData(
  input: DeepPartial<ShippingFeatureData>
): ShippingFeatureData {
  return {
    id: input.id || '',
    name: input.name || '',
    config: input.config || {},
  } as ShippingFeatureData;
}
