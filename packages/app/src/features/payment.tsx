...
export type PaymentFeatureProps = PropsWithChildren<{
  readonly paymentId?: string;
  readonly data?: DeepReadonly<Record<string, unknown>>;
  readonly onUpdate?: (data: DeepReadonly<Record<string, unknown>>) => void;
}>;

export const PaymentFeature: FC<PaymentFeatureProps> = (props: PaymentFeatureProps) => {
...
export type PaymentFeatureData = DeepReadonly<{
  readonly id: string;
  readonly name: string;
  readonly config: DeepReadonly<Record<string, unknown>>;
}>;

export function getPaymentFeatureData(): PaymentFeatureData {
  return {
    id: 'payment-1',
    name: 'Payment',
    config: {},
...
export function transformPaymentFeatureData(
  input: DeepPartial<PaymentFeatureData>
): PaymentFeatureData {
  return {
    id: input.id || '',
    name: input.name || '',
    config: input.config || {},
  } as PaymentFeatureData;
}
