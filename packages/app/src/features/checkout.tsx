...
export type CheckoutFeatureProps = PropsWithChildren<{
  readonly checkoutId?: string;
  readonly data?: DeepReadonly<Record<string, unknown>>;
  readonly onUpdate?: (data: DeepReadonly<Record<string, unknown>>) => void;
}>;

export const CheckoutFeature: FC<CheckoutFeatureProps> = (props: CheckoutFeatureProps) => {
...
export type CheckoutFeatureData = DeepReadonly<{
  readonly id: string;
  readonly name: string;
  readonly config: DeepReadonly<Record<string, unknown>>;
}>;

export function getCheckoutFeatureData(): CheckoutFeatureData {
  return {
    id: 'checkout-1',
    name: 'Checkout',
    config: {},
...
export function transformCheckoutFeatureData(
  input: DeepPartial<CheckoutFeatureData>
): CheckoutFeatureData {
  return {
    id: input.id || '',
    name: input.name || '',
    config: input.config || {},
  } as CheckoutFeatureData;
}
