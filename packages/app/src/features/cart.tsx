...
export type CartFeatureData = DeepReadonly<{
  readonly id: string;
  readonly name: string;
  readonly config: DeepReadonly<Record<string, unknown>>;
}>;

export function getCartFeatureData(): CartFeatureData {
  return {
    id: 'cart-1',
    name: 'Cart',
    config: {},
...
export function transformCartFeatureData(
  input: DeepPartial<CartFeatureData>
): CartFeatureData {
  return {
    id: input.id || '',
    name: input.name || '',
