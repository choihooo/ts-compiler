...
export type UserFeatureData = DeepReadonly<{
  readonly id: string;
  readonly name: string;
  readonly config: DeepReadonly<Record<string, unknown>>;
}>;

export function getUserFeatureData(): UserFeatureData {
  return {
    id: 'user-1',
    name: 'User',
    config: {},
...
export function transformUserFeatureData(
  input: DeepPartial<UserFeatureData>
): UserFeatureData {
  return {
    id: input.id || '',
    name: input.name || '',
