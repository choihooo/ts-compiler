...
export type OrderFeatureProps = PropsWithChildren<{
  readonly orderId?: string;
  readonly data?: DeepReadonly<Record<string, unknown>>;
  readonly onUpdate?: (data: DeepReadonly<Record<string, unknown>>) => void;
}>;

export const OrderFeature: FC<OrderFeatureProps> = (props: OrderFeatureProps) => {
...
export type OrderFeatureData = DeepReadonly<{
  readonly id: string;
  readonly name: string;
  readonly config: DeepReadonly<Record<string, unknown>>;
}>;

export function getOrderFeatureData(): OrderFeatureData {
  return {
    id: 'order-1',
    name: 'Order',
    config: {},
...
export function transformOrderFeatureData(
  input: DeepPartial<OrderFeatureData>
): OrderFeatureData {
  return {
    id: input.id || '',
    name: input.name || '',
